...
This repository contains the Open Water Foundation TSTool plugin for the Synoptic web services.
This plugin can be installed to enable commands that integrate TSTool with Synoptic data services.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-synoptic-plugin/owf-tstool-synoptic-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-synoptic-plugin` in ***Package Explorer*** or ***Project Explorer***
...
1.  Eclipse project:
    1.  The `owf-tstool-synoptic-plugin` repository is added as a Maven project.
...
2.  Plugin jar file:
    ...
    3.  The above script relies on the `owf-tstool-synoptic-plugin/src/main/resources/META-INF/MANIFEST.MF`
...
1.  Update the version:
    1.  Update the `src/main/java/owf-tstool-synoptic-plugin/org/openwaterfoundation/tstool/plugin/synoptic/PluginMeta.java` source file.

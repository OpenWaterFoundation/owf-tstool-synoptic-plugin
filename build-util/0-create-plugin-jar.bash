...
#   ./tstool/NN/plugins/owf-tstool-synoptic-plugin/ folder for use by TSTool
...
mavenProjectFolder=${repoFolder}/owf-tstool-synoptic-plugin
...
manifestFile="${repoFolder}/owf-tstool-synoptic-plugin/src/main/resources/META-INF/MANIFEST.MF"

// PluginMetadata - metadata for the TSTool Synoptic plugin
...
package org.openwaterfoundation.tstool.plugin.synoptic;
...
public class PluginMeta {
	 ...
	 *	  https://software.openwaterfoundation.org/owf-tstool-synoptic-plugin/latest/doc-user/
	 */
	public static String documentationRootUrl() {
		// Hard code for now until figure out how to configure in the META-INF.
		String url = "https://software.openwaterfoundation.org/owf-tstool-synoptic-plugin/latest/doc-user/";
		return url;
	}

// MetadataStation - class containing a Synoptic station metadata station
...
/**
 * Objects corresponding the 'metadata' request STATION array items,
 * which are used to get a time series list.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class MetadataStation {
	...
	private PeriodOfRecord periodOfRecord = null;
